...
export default function Profile() {
    return(
        <section className='maryLouise-container'>
                ...
                <hr />
                <p>Mary Louise Fazzano is the President of Giving Focus LLC® 
                a career consulting and advisory firm serving individuals at the start of their career, in transition, or seeking career advancement.
